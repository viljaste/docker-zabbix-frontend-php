class zabbix_web::httpd {
  require zabbix_web::httpd::packages
  require zabbix_web::httpd::supervisor
  ...
  file { '/etc/apache2/conf-available/logs.conf':
    ...
    source => 'puppet:///modules/zabbix_web/etc/apache2/conf-available/logs.conf',
    mode => 644
  }
